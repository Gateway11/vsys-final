...
#define ZLOG_INFO(...) {char info[1024]; sprintf(info,__VA_ARGS__);__android_log_print(ANDROID_LOG_INFO,"RKUPL_r2audio",info);}
#define ZLOG_ERROR(...) {char info[1024]; sprintf(info,__VA_ARGS__);__android_log_print(ANDROID_LOG_ERROR,"RKUPL_r2audio",info);}
#else
#define ZLOG_INFO(...){ char info[1024]; sprintf(info,__VA_ARGS__); printf(info);printf("\n");}
#define ZLOG_ERROR(...){ char info[1024]; sprintf(info,__VA_ARGS__); printf(info);printf("\n");}
#endif
