...
MY_PRJ_DIR := $(MY_SLV_DIR)/testr2

include $(CLEAR_VARS)
LOCAL_MODULE    := r2ad
LOCAL_SRC_FILES := $(MY_SLV_DIR)/r2ad3/libs/$(TARGET_ARCH_ABI)/libr2audio.so
...
MY_FILES_PATH  :=  $(MY_PRJ_DIR)/testr2
...
LOCAL_SHARED_LIBRARIES := r2ad r2vt
