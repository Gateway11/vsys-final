...
*
****************************/
#ifndef _KRFFT_INL_2009_OCT_28_BY_KDF_
#define _KRFFT_INL_2009_OCT_28_BY_KDF_
...
KRFFT<flt_t>::KRFFT (const long length)
:	_length (length)
,	_nbr_bits (int (floor (log (length*1.0f) / log (2.0f) + 0.5)))
,	_bit_rev_lut (int (floor (log (length*1.0f) / log (2.0f) + 0.5)))
,	_trigo_lut (int (floor (log (length*1.0f) / log (2.0f) + 0.5)))
,	_sqrt2_2 (flt_t (sqrt (2.0f) * 0.5))
{
...
/*==========================================================================*/
template<typename flt_t>
void	KRFFT<flt_t>::do_fft (flt_t f [], const flt_t x []) const
{
...
/*==========================================================================*/
template<typename flt_t>
void	KRFFT<flt_t>::do_ifft (const flt_t f [], flt_t x []) const
{
...
/*==========================================================================*/
template<typename flt_t>
void	KRFFT<flt_t>::rescale (flt_t x []) const
{
...
/*==========================================================================*/
template<typename flt_t>
BitReversedLUT<flt_t>::BitReversedLUT (const int nbr_bits)
{
	long				length;
	long				cnt;
	long				br_index;
...
/*==========================================================================*/
template<typename flt_t>
BitReversedLUT<flt_t>::~BitReversedLUT (void)
{
	delete [] _ptr;
	_ptr = 0;
}
...
/*==========================================================================*/
template<typename flt_t>
TrigoLUT<flt_t>::TrigoLUT (const int nbr_bits)
{
	long		total_len;
