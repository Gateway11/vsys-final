...
#ifndef __r2vt5__zvbvapi__
#define __r2vt5__zvbvapi__
 ...
 *  @return 0:成功；1：失败
 */
#define R2_VBV_PARAM_INT_NS      1     //默认值1，ns算法打开
#define R2_VBV_PARAM_INT_DIRTY   2     //默认值1，dirty算法打开
 ...
 *
 *  @param hTask             麦克风阵列激活算法句柄
 *  @param pWordContent_UTF8 激活词
 *  @param iParam            参数编号(参考r2_vt_setparam函数说明)
 *  @param pValue            参数值
 *
 *  @return 0:成功；1：失败
 */
int r2_vbv_set_vt_param(r2_vbv_htask hTask, const char* pWordContent_UTF8, const int iParam, const void* pValue);
