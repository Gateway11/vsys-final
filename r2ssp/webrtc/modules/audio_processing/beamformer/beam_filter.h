...
#ifndef WEBRTC_MODULES_AUDIO_PROCESSING_BEAMFORMER_BEAM_FILTER_H_
#define WEBRTC_MODULES_AUDIO_PROCESSING_BEAMFORMER_BEAM_FILTER_H_
...
class BeamFilter : public LappedTransform::Callback {
 public:
  explicit BeamFilter();
  ...
  int SetFreqScales(float *scales, int length);
...
#endif  // WEBRTC_MODULES_AUDIO_PROCESSING_BEAMFORMER_BEAM_FILTER_H_
