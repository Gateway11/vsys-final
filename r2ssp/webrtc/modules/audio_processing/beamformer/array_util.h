...
template<typename T>
float DistanceXY(CartesianPoint<T> a, CartesianPoint<T> b) {
  return std::sqrt((a.x() - b.x()) * (a.x() - b.x()) +
                   (a.y() - b.y()) * (a.y() - b.y()));
}

template<typename T>
float DistanceXYElev(CartesianPoint<T> a, CartesianPoint<T> b, T elevation) {
  return std::sqrt((a.x() - b.x()) * (a.x() - b.x()) +
                   (a.y() - b.y()) * (a.y() - b.y())) * std::cos(elevation);
}
